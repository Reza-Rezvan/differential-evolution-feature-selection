...
plt.scatter("accuracy Target", accuracy_score(Test_y, predicted))
...
plt.scatter("accuracy Trial", accuracy_score(Test_y, predicted_T))
...
plt.scatter("accuracy NEW", accuracy_score(Test_y, predicted_N))